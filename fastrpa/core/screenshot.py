...
class Screenshot:
    ...
    def _restore_window(self, size: dict[str, int], position: dict[str, int], is_maximized: bool):
        if not is_maximized:
    ...
    def is_maximized(self) -> bool:
        ...
        screen_height = self.webdriver.execute_script("return screen.availHeight")
        return (window_size['width'] == screen_width) and (window_size['height'] == screen_height)
